...
`https://211-233-193-159.sslip.io` 에서 돌아가는 OCR 서버 코드 그대로입니다 (v0.2.1, 2026-09-23 배포).
...
업로드 파일 (JPEG/PNG/HEIC/PDF 앞 5쪽)
  ...
  → ocr/validate.py        유효범위, 교차검증(BMI·체지방률 재계산, 골격근량·체지방량 < 체중, 부호 복원, 혈압 순서)
...
| 교차검증 → review_required | ✅ BMI ≈ 체중/신장², 체지방률 ≈ 체지방량/체중×100 (1%p 초과 시), 골격근량·체지방량 < 체중 (v0.2.1) |
