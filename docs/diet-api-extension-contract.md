...
상태: 로컬 구현·검증 및 원격 Supabase 마이그레이션 완료, 서버 배포 대기
기준일: 2026-09-16
...
| 공유 서버 배포 및 실제 API 통합 확인 | 미진행 |

`20260916042556_replace_diet_meal.sql`은 연결된 개발 Supabase에 적용됐다.
프론트엔드는 공유 서버에 백엔드 코드가 배포된 뒤 실연동한다.
